...
| **问题三** | 画像分型 + 约束组合优化 | `backend/models/intervention_optimization.py` | 代谢异常→优先调理，肥胖→调理+运动，功能受限→低强度改善，6个月成本≤2000元 |
...
2. **风险计算** → 一键调用后端API，执行三大算法
3. **风险结果** → 展示低/中/高风险分级、异常因素、患者分型
4. **干预推荐** → 按分型给出最优方案，展示成本与预期效果，提供备选方案
